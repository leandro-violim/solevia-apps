...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "home.tapToPlay": "Tap to play",
    "home.worldPhase": "World {world} · Phase {phase}",
    "home.teaser": "Tap & pop!",
    "home.here": "You are here",
    "map.title": "Your journey",
    "map.portal": "Next world",
    ...
    "play.bubblesLeftShort": "{n} left",
    "challenge.title": "Pop Challenge",
    "challenge.in": "In {t}",
    "challenge.mPop": "Pop {n} bubbles",
    "challenge.mCombo": "Reach a ×{n} combo",
    "challenge.mClear": "Clear the whole sheet",
    "challenge.mFast": "Clear the sheet under {n}s",
    "challenge.win": "Mission complete!",
    "challenge.miss": "So close!",
    "challenge.winDesc": "You nailed it — here's your reward.",
    "challenge.missDesc": "Not this time — but here's a little something.",
    ...
    "finish.tryAgain": "Try this phase again",
  ...
  pt: {
    ...
    "home.tapToPlay": "Toque para jogar",
    "home.worldPhase": "Mundo {world} · Fase {phase}",
    "home.teaser": "Toque e estoure!",
    "home.here": "Você está aqui",
    "map.title": "Sua jornada",
    "map.portal": "Próximo mundo",
    ...
    "play.bubblesLeftShort": "faltam {n}",
    "challenge.title": "Desafio Pop",
    "challenge.in": "Em {t}",
    "challenge.mPop": "Estoure {n} bolhas",
    "challenge.mCombo": "Faça um combo ×{n}",
    "challenge.mClear": "Limpe a cartela inteira",
    "challenge.mFast": "Limpe a cartela em menos de {n}s",
    "challenge.win": "Missão cumprida!",
    "challenge.miss": "Quase lá!",
    "challenge.winDesc": "Você mandou bem — aqui está sua recompensa.",
    "challenge.missDesc": "Dessa vez não — mas leve um agrado.",
    ...
    "finish.tryAgain": "Tentar esta fase de novo",
  ...
  es: {
    ...
    "home.tapToPlay": "Toca para jugar",
    "home.worldPhase": "Mundo {world} · Fase {phase}",
    "home.teaser": "¡Toca y revienta!",
    "home.here": "Continúa aquí",
    "map.title": "Tu viaje",
    "map.portal": "Siguiente mundo",
    ...
    "play.bubblesLeftShort": "quedan {n}",
    "challenge.title": "Desafío Pop",
    "challenge.in": "En {t}",
    "challenge.mPop": "Revienta {n} burbujas",
    "challenge.mCombo": "Logra un combo ×{n}",
    "challenge.mClear": "Limpia toda la lámina",
    "challenge.mFast": "Limpia la lámina en menos de {n}s",
    "challenge.win": "¡Misión cumplida!",
    "challenge.miss": "¡Casi!",
    "challenge.winDesc": "Lo lograste: aquí tienes tu recompensa.",
    "challenge.missDesc": "Esta vez no, pero llévate un detalle.",
    "challenge.rewardCoins": "monedas",
    ...
    "finish.tryAgain": "Reintentar esta fase",
