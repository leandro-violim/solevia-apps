...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Terms of use for the Zen Bubbles relaxation game.",
      },
...
function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 pb-[calc(env(safe-area-inset-bottom)+2.5rem)] pt-[calc(env(safe-area-inset-top)+1.5rem)] text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2 text-xs text-muted-foreground">Last updated: July 21, 2026</p>

      <p className="mt-6">
        These Terms govern your use of Zen Bubbles ("the App"). By installing or using the App you
      ...
      <p className="mt-2">
        ...
        use the App on devices you own or control, for your personal, non-commercial enjoyment.
      </p>

      <h2 className="mt-8 text-lg font-semibold">Acceptable use</h2>
      <p className="mt-2">
        You agree not to reverse engineer, modify, or redistribute the App, or attempt to interfere
        with its normal operation or security.
      </p>

      <h2 className="mt-8 text-lg font-semibold">Advertising</h2>
      <p className="mt-2">
        The App displays advertisements. Advertisers are third parties and we are not responsible
        for the content of their ads or the sites they link to.
      </p>

      <h2 className="mt-8 text-lg font-semibold">No medical claims</h2>
      <p className="mt-2">
        The App is intended for entertainment and relaxation. It is not a medical device and does
        not provide medical, psychological, or therapeutic advice. If you need professional help,
      ...
      <p className="mt-2">
        ...
        between you and Sole Via Entertainment LLC only, not with Apple, and that Apple is not
        responsible for the App or its content. Apple and its subsidiaries are third-party
        beneficiaries of these Terms and may enforce them against you.
      </p>

      <h2 className="mt-8 text-lg font-semibold">Changes</h2>
      <p className="mt-2">
        We may update these Terms. Continued use of the App after changes become effective
