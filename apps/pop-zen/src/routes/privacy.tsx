...
function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 pb-[calc(var(--ad-banner-h,72px)+env(safe-area-inset-bottom)+1.25rem)] pt-[calc(env(safe-area-inset-top)+1.5rem)] text-sm leading-relaxed text-foreground">
      ...
      <p className="mt-2">
        The App stores your best score and best time per phase, your most recent results, and
        settings (such as whether the pop sound is on) in your device's local storage. This stays on
        your device, we cannot read it, and it is not sent to us. You can erase it any time from the
        Records or Settings screen (Reset records) or by uninstalling the App.
      </p>
      ...
      <p className="mt-2">
        On iOS, before any cross-app tracking identifier (the IDFA) is used for personalized
        advertising, the App shows Apple's App Tracking Transparency prompt. You can allow or deny
        tracking and change your choice any time at Settings → Privacy & Security → Tracking. If you
        deny tracking, you will still see ads, but they will be less relevant.
      </p>

      <h2 className="mt-8 text-lg font-semibold">5. Consent in the EEA, UK and Switzerland</h2>
      <p className="mt-2">
        Where required by the GDPR and related laws, the App uses Google's consent mechanism (the
        UMP SDK) to ask for your consent before personalized ads are shown and to let you manage
        your choices. Personalized advertising occurs only where you have consented.
      </p>

      <h2 className="mt-8 text-lg font-semibold">6. Your US state privacy rights</h2>
      <p className="mt-2">
        We do not sell your personal information for money. However, using your advertising
        identifier for personalized ads may be considered "sharing" for cross-context behavioral
        advertising, or a "sale," under some US state laws such as the California Consumer Privacy
        Act. You can opt out by declining the tracking prompt (iOS), withholding advertising
        consent, or limiting ad personalization in your device settings (below).
      </p>

      <h2 className="mt-8 text-lg font-semibold">7. Children</h2>
      <p className="mt-2">
        The App is a general-audience relaxation game and is not directed to children under 13. We
        do not knowingly collect personal information from children, and ads served in the App are
        configured for a general audience, not for child-directed treatment.
      </p>
      ...
      <p className="mt-2">
        On-device data remains until you reset it or uninstall the App. Information collected by
        Google for advertising is retained and processed by Google under its own policies, and may
        be processed in the United States or other countries.
      </p>
      ...
      <p className="mt-2">
        ...
        the "Last updated" date above. Continued use of the App after an update means you accept the
        revised policy.
      </p>
