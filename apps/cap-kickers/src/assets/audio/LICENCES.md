...
- **Cap foley** (`flick-1..4`, `clack-1..3`) and **ambience beds** (`amb-stadium`,
  `amb-chant`) — generated with ElevenLabs; no third-party recording, no trademark
  exposure. Prompts, takes and measurements: `AMBIENCE-PROVENANCE.md`. These replaced
  the interim `amb-crowd.m4a` (a cut of the Pixabay 72194 recording, now retired) and
