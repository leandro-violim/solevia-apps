...
const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "play.rewardUnlocked": "New unlock!",
    "play.rewardPitch": "New pitch",
    "play.rewardAudio": "New sound pack",
    "play.nice": "Nice!",
    "play.doubleCaps": "2× Caps (+{n})",
    "play.capsDoubled": "Doubled — {n} Caps!",
    ...
    "cap.soda-blue": "Soda",
    "cap.crown-red": "Crown",
    "cap.spring-teal": "Spring",
    "cap.sport-orange": "Sport",
    "cap.retro-gold": "Retro",
    "cap.neon-pink": "Neon",
    "cap.grape-purple": "Grape",
    "cap.lime-green": "Lime",
    "cap.brass-gold": "Gold",
    "cap.metal-silver": "Chrome",
    "cap.metal-red": "Ruby",
    "cap.metal-blue": "Cobalt",
    "cap.metal-green": "Emerald",
    "cap.metal-orange": "Copper",
    "cap.metal-purple": "Amethyst",
    "cap.gold-legendary": "Legend",
    ...
    "campaign.nextReward": "Next reward",
    "campaign.nextRewardCta": "Win Phase {n} · {name}",
    "campaign.allUnlockedTitle": "All rewards unlocked!",
    "campaign.allUnlockedBody": "You've collected every prize on the road.",
    "campaign.grandPrize": "Grand prize",
    "campaign.grandPrizeCta": "Clear all phases",
    "campaign.chestTitle": "Mystery Chest",
    "campaign.chestBody": "Watch to open — bonus Caps",
    "campaign.chestOpen": "Open",
    "campaign.chestWon": "You won +{n} Caps!",
    "campaign.chestDone": "Opened — come back tomorrow",
    ...
    "campaign.level.l3": "Prospect",
    "campaign.level.l4": "Regular",
    "campaign.level.l5": "Starter",
    "campaign.level.l6": "Veteran",
    "campaign.level.l7": "Captain",
    "campaign.level.l8": "Pro",
    "campaign.level.l9": "All-Star",
    "campaign.level.l10": "Elite",
    "campaign.level.l11": "Ace",
    "campaign.level.l12": "Star",
    "campaign.level.l13": "Legend",
    "campaign.level.l14": "Champion",
    ...
    "cabinet.reqReward": "Earn by clearing phases",
    "cabinet.packCrowd": "Crowd Pack",
    "cabinet.packStadium": "Stadium Ambience",
    "cabinet.packCommentary": "Commentary Pack",
  ...
  "pt-BR": {
    ...
    "play.rewardUnlocked": "Novo desbloqueio!",
    "play.rewardPitch": "Novo campo",
    "play.rewardAudio": "Novo pacote de sons",
    "play.nice": "Boa!",
    "play.doubleCaps": "2× Tampinhas (+{n})",
    "play.capsDoubled": "Dobrou — {n} Tampinhas!",
    ...
    "cap.soda-blue": "Refri",
    "cap.crown-red": "Coroa",
    "cap.spring-teal": "Mola",
    "cap.sport-orange": "Esporte",
    "cap.retro-gold": "Retrô",
    "cap.neon-pink": "Neon",
    "cap.grape-purple": "Uva",
    "cap.lime-green": "Limão",
    "cap.brass-gold": "Ouro",
    "cap.metal-silver": "Cromado",
    "cap.metal-red": "Rubi",
    "cap.metal-blue": "Cobalto",
    "cap.metal-green": "Esmeralda",
    "cap.metal-orange": "Cobre",
    "cap.metal-purple": "Ametista",
    "cap.gold-legendary": "Lenda",
    ...
    "campaign.nextReward": "Próximo prêmio",
    "campaign.nextRewardCta": "Vença a Fase {n} · {name}",
    "campaign.allUnlockedTitle": "Todos os prêmios desbloqueados!",
    "campaign.allUnlockedBody": "Você coletou todos os prêmios do caminho.",
    "campaign.grandPrize": "Grande prêmio",
    "campaign.grandPrizeCta": "Complete todas as fases",
    "campaign.chestTitle": "Baú Misterioso",
    "campaign.chestBody": "Assista para abrir — Tampinhas extras",
    "campaign.chestOpen": "Abrir",
    "campaign.chestWon": "Você ganhou +{n} Tampinhas!",
    "campaign.chestDone": "Aberto — volte amanhã",
    ...
    "campaign.level.l3": "Promessa",
    "campaign.level.l4": "Regular",
    "campaign.level.l5": "Titular",
    "campaign.level.l6": "Veterano",
    "campaign.level.l7": "Capitão",
    "campaign.level.l8": "Profissional",
    "campaign.level.l9": "Craque",
    "campaign.level.l10": "Elite",
    "campaign.level.l11": "Ás",
    "campaign.level.l12": "Estrela",
    "campaign.level.l13": "Lenda",
    "campaign.level.l14": "Campeão",
    ...
    "cabinet.reqReward": "Ganhe completando fases",
    "cabinet.packCrowd": "Pacote de Torcida",
    "cabinet.packStadium": "Ambiente de Estádio",
    "cabinet.packCommentary": "Pacote de Narração",
  ...
  es: {
    ...
    "play.rewardUnlocked": "¡Nuevo desbloqueo!",
    "play.rewardPitch": "Nueva cancha",
    "play.rewardAudio": "Nuevo paquete de sonido",
    "play.nice": "¡Genial!",
    "play.doubleCaps": "2× Tapitas (+{n})",
    "play.capsDoubled": "¡Duplicado — {n} Tapitas!",
    ...
    "pitch.night": "Nocturno",
    "pitch.street": "Calle",
    "pitch.beach": "Playa",
    "cap.soda-blue": "Soda",
    "cap.crown-red": "Corona",
    "cap.spring-teal": "Resorte",
    "cap.sport-orange": "Deporte",
    "cap.retro-gold": "Retro",
    "cap.neon-pink": "Neón",
    "cap.grape-purple": "Uva",
    "cap.lime-green": "Lima",
    "cap.brass-gold": "Oro",
    "cap.metal-silver": "Cromo",
    "cap.metal-red": "Rubí",
    "cap.metal-blue": "Cobalto",
    "cap.metal-green": "Esmeralda",
    "cap.metal-orange": "Cobre",
    "cap.metal-purple": "Amatista",
    "cap.gold-legendary": "Leyenda",
    ...
    "campaign.nextReward": "Próximo premio",
    "campaign.nextRewardCta": "Gana la Fase {n} · {name}",
    "campaign.allUnlockedTitle": "¡Todos los premios desbloqueados!",
    "campaign.allUnlockedBody": "Has reunido todos los premios del camino.",
    "campaign.grandPrize": "Gran premio",
    "campaign.grandPrizeCta": "Completa todas las fases",
    "campaign.chestTitle": "Cofre Misterioso",
    "campaign.chestBody": "Míralo para abrir — Tapitas extra",
    "campaign.chestOpen": "Abrir",
    "campaign.chestWon": "¡Ganaste +{n} Tapitas!",
    "campaign.chestDone": "Abierto — vuelve mañana",
    "campaign.locked": "Bloqueado",
    "campaign.play": "Jugar",
    ...
    "campaign.level.l1": "Novato",
    "campaign.level.l2": "Amateur",
    "campaign.level.l3": "Promesa",
    "campaign.level.l4": "Regular",
    "campaign.level.l5": "Titular",
    "campaign.level.l6": "Veterano",
    "campaign.level.l7": "Capitán",
    "campaign.level.l8": "Profesional",
    "campaign.level.l9": "Crack",
    "campaign.level.l10": "Élite",
    "campaign.level.l11": "As",
    "campaign.level.l12": "Estrella",
    "campaign.level.l13": "Leyenda",
    "campaign.level.l14": "Campeón",
    ...
    "cabinet.reqReward": "Gana completando niveles",
    "cabinet.packCrowd": "Pack de Público",
    "cabinet.packStadium": "Ambiente de Estadio",
    "cabinet.packCommentary": "Pack de Narración",
