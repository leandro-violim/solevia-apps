...
const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.audioTest": "Audio packs (test)",
    "settings.audioTestHint": "Turn on to hear a preview",
    "settings.audioSelfTest": "Audio self-test",
    "settings.audioSelfTestHint": "Plays a beep, then a crowd clip",
  ...
  "pt-BR": {
    ...
    "settings.audioTest": "Pacotes de áudio (teste)",
    "settings.audioTestHint": "Ative para ouvir uma prévia",
    "settings.audioSelfTest": "Autoteste de áudio",
    "settings.audioSelfTestHint": "Toca um bipe e depois um trecho de torcida",
  ...
  es: {
    ...
    "settings.audioTest": "Paquetes de audio (prueba)",
    "settings.audioTestHint": "Actívalo para oír una muestra",
    "settings.audioSelfTest": "Autoprueba de audio",
    "settings.audioSelfTestHint": "Suena un bip y luego un clip de público",
    "settings.language": "Idioma",
